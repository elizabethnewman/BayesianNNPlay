...
def setup_parser():
    ...
    parser.add_argument('--mask', action='store_true', default=True, help='mask function')
    ...
    parser.add_argument('--gap', type=float, default=[0, 0], help='there exist a gap')
    parser.add_argument('--test', type=int, default=0, help='we are testing')

    # training
    parser.add_argument('--max_epochs', type=int, default=60, help='maximum number of epochs')
